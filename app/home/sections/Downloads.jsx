    ...
    <section className='bg-dark lg:mx-20 mx-4'>
        {
            ...
            <div className="lg:col-span-2  col-span-5 lg:py-20 py-3 ">
                <Image src={item.img} alt=''/>
                <h5 className='my-5 text-white text-4xl font-semibold'>
                    {item.name}
                </h5>
                ...
                <div className='lg:my-5 my-3 mr-4 '>
                    <button className='border font-medium w-full lg:text-base text-sm  lg:py-4 p-4  text-h2head bg-lightDark border-lineColor rounded-lg'>
                        Download {item.name} Now <span className='mr-1 text-logo text-lg     inline-block '><MdArrowOutward /></span>
                    </button>
                </div>
                <div className='border font-medium w-auto lg:my-3 my-0 lg:p-4 p-3  bg-lightDark border-lineColor rounded-xl flex mr-14 lg:mr-0 lg:inline-flex items-center'>
                    <div>
                ...
                <Image src={people}  className="img-fluid rounded-top size-10"    alt="client"/>
                <Image src={people4} className="img-fluid rounded-top size-10 ml-[-10px]"   alt="client"/>
                <Image src={people2} className="img-fluid rounded-top size-10 ml-[-10px]"
                    alt="client"
                />
                <Image
                    src={people3}
                    className="img-fluid rounded-top size-10 ml-[-10px]"
                    alt="client"
                />
                </div>
                </div>
            ...
            <div className="lg:col-span-3 col-span-5 lg:py-20 py-5 lg:border-l border-t  lg:border-t-0  border-lineColor">
                <div className='lg:ml-8 flex justify-between item-center flex-wrap'>
                    <h5 className='text-white lg:w-[30%] font-semibold text-lg'>
                            Variety of Topics
                    </h5>
                    <p className='text-h2head text-sm lg:w-[70%]'>
                    {item.rightDisc}
                    </p>
                </div>
                <div className='my-4 lg:mr-5'>
                    ...
                    <div className='flex justify-between items-center  flex-wrap lg:flex-nowrap gap-y-3 '>
                        <div className='lg:w-[30%] w-full border  border-lineColor p-5 lg:ml-8 rounded-lg bg-lightDark'>
                            <p className='text-h2head text-sm'> Total {item.name} </p>
                            <p className='text-white '> {item.total}</p>
                        </div>
                        <div className='lg:w-[70%] w-full border border-lineColor p-5 lg:ml-8 rounded-lg bg-lightDark'>
                            <p className='text-h2head text-sm'> Download Formats</p>
                            <div className='flex justify-between items-center'>
                            <p className='text-white '> PDF format for access. </p>
                    ...
                    <div className='  border border-lineColor p-5 my-3 lg:ml-8   rounded-lg bg-lightDark'>
                            <p className='text-h2head text-sm'> Average Author Expertise</p>
                            <p className='text-white '> {item.bottomDisc}</p>
                        </div>
            </div>
        </div>
                    </>
